...
namespace MilmaxScience.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ShortDescription,FullDescription,EventDateTime,MaxParticipants,CityId,SpeakerId,EventTypeId,OrganiserId")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ShortDescription,FullDescription,EventDateTime,MaxParticipants,CityId,SpeakerId,EventTypeId,OrganiserId")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
