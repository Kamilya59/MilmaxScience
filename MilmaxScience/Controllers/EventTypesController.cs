...
namespace MilmaxScience.Controllers
{
    public class EventTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DisplayName,Slug")] EventType eventType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DisplayName,Slug")] EventType eventType)
        {
            if (id != eventType.Id)
            {
                return NotFound();
